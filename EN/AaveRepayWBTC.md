...
```output-Dynamic
assert(L2Lending.aaveV2.getIsActive("wbtc"), "Repayment is limited due to the circuit status of the market.");
...
assert(Q.Token.balanceOf("wbtc") >= amount, "Insufficient WBTC available to repay.");
