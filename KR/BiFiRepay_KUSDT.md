...
Chainrunner Q는 이 문서의 내용대로 BiFi에서 대출한 KUSDT를 상환합니다.
...
assert(amountRepayMax > 0.000001 kusdt, "상환 가능한 금액이 너무 적습니다.");
...
assert(Q.Token.balanceOf("kusdt") >= amountRepay, "상환할 수 있는 KUSDT가 부족합니다.");
assert(Q.bifi.getMaxRepayAmount("kusdt") >= amountRepay, "부채보다 많은 금액을 상환할수 없습니다.");
```
