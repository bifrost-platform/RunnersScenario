...
Chainrunner Q는 이 문서의 내용대로 BiFi에 예금한 KUSDC를 출금합니다.
...
assert(amountWithdrawMax > 0.000001 kusdc, "출금 가능한 금액이 너무 적습니다.");
...
assert(Q.bifi.getMaxWithdrawAmount("kusdc") >= amountWithdraw, "출금 가능한 KUSDC가 부족합니다.");
```
