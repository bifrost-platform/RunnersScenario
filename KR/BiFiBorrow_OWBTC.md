...
Chainrunner Q는 이 문서의 내용대로 BiFi에서 oWBTC를 대출합니다.
...
assert(amountBorrowMax > 0.000001 owbtc, "대출 가능한 금액이 너무 적습니다.");
...
assert(Q.bifi.getBorrowableAmount("owbtc") >= amountBorrow, "빌릴 수 있는 oWBTC가 부족합니다.");
```
