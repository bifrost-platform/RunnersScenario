...
Chainrunner Q는 이 문서의 내용대로 BiFi에 예금한 oXRP를 출금합니다.
...
assert(amountWithdrawMax > 0.000001 oxrp, "출금 가능한 금액이 너무 적습니다.");
...
assert(Q.bifi.getWithdrawableAmount("oxrp") >= amountWithdraw, "출금 가능한 oXRP가 부족합니다.");
```
