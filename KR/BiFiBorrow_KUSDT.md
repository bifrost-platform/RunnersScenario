...
Chainrunner Q는 이 문서의 내용대로 BiFi에서 KUSDT를 대출합니다.
...
assert(amountBorrowMax > 0.000001 kusdt, "대출 가능한 금액이 너무 적습니다.");
...
assert(Q.bifi.getMaxBorrowAmount("kusdt") >= amountBorrow, "빌릴 수 있는 KUSDT가 부족합니다.");
```
