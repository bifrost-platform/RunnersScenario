...
Chainrunner Q는 이 문서의 내용대로 BiFi에서 대출한 oETH를 상환합니다.
...
assert(amountRepayMax > 0.000001 oeth, "상환 가능한 금액이 너무 적습니다.");
...
assert(Q.Token.balanceOf("oeth") >= amountRepay, "상환할 수 있는 oETH가 부족합니다.");
assert(Q.bifi.getRepayableAmount("oeth") >= amountRepay, "부채보다 많은 금액을 상환할수 없습니다.");
```
